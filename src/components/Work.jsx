...
const PROJECTS = [
  ...
  },
  {
    ...
    features: [
      "AI-powered summaries, flashcards & quizzes from uploads",
      "Full Sinhala language localization (සිංහල)",
      "Interactive PDF chat with cited AI answers",
      "Gamified learning: streaks & achievements",
      "Built-in Pomodoro timer for study focus",
      "Credit system for AI usage management",
    ],
    tags: ["TypeScript", "React", "Supabase", "AI"],
    href: "https://github.com/Thiva123-ab/study_buddy",
    icon: "📚",
    img: studySummary,
  ...
  },
  {
    ...
    features: [
      "Interactive customer booking portal with quick scheduling CTAs",
      "Comprehensive admin dashboard for holistic garage overview",
      "Real-time inventory tracking with low stock alerts",
      "Appointment scheduling and detailed booking management",
      "Extensive service catalog with pricing and duration estimates",
      "Full CRUD operations for managing inventory items and services",
      "Cloud Firestore database integration for real-time sync"
    ],
